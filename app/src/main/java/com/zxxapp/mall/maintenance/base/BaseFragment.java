...
public abstract class BaseFragment<SV extends ViewDataBinding> extends Fragment {
    ...
    // 加载中
    protected LinearLayout mLlProgressBar;
    // 加载失败
    protected LinearLayout mRefresh;
    // 数据为空
    protected LinearLayout mEmpty;
    // 需要登录
    protected LinearLayout mNeedLogin;
    // 内容布局
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mEmpty  = getView(R.id.ll_empty);
        mNeedLogin  = getView(R.id.ll_need_login);
        ...
        mNeedLogin.setOnClickListener(new PerfectClickListener() {
            @Override
            protected void onNoDoubleClick(View v) {
    ...
    protected void showNeedLogin() {
        ...
        if (mNeedLogin.getVisibility() != View.VISIBLE) {
