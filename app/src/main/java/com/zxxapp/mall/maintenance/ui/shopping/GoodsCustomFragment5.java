...
public class GoodsCustomFragment5 extends BaseFragment<FragmentGoodsCustomBinding>{
    ...
    public static GoodsCustomFragment5 newInstance() {
        GoodsCustomFragment5 fragment = new GoodsCustomFragment5();
        return fragment;
    }
