...
public class GoodsCustomFragment6 extends BaseFragment<FragmentGoodsCustomBinding>{
    ...
    public static GoodsCustomFragment6 newInstance() {
        GoodsCustomFragment6 fragment = new GoodsCustomFragment6();
        return fragment;
    }
