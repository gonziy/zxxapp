package com.zxxapp.mall.maintenance.view.paymentradio;
...
public class PayRadioPurified extends RelativeLayout implements Checkable {
	...
	public PayRadioPurified(Context context, AttributeSet attrs) {
		...
		inflater.inflate(R.layout.item_payment,this);
		...
		d.setBounds(0,0,DensityUtil.dip2px(20),DensityUtil.dip2px(20));
		if (d != null) {
			payChecked.setCompoundDrawables(null, d, null, null);//只放上面
		}
