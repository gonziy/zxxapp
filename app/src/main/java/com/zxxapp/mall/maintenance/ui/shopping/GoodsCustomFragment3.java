...
public class GoodsCustomFragment3 extends BaseFragment<FragmentGoodsCustomBinding>{
    ...
    public static GoodsCustomFragment3 newInstance() {
        GoodsCustomFragment3 fragment = new GoodsCustomFragment3();
        return fragment;
    }
