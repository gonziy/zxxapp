...
import com.zxxapp.mall.maintenance.ui.mine.child.SignWebViewActivity;
import com.zxxapp.mall.maintenance.utils.CheckNetwork;
...
public class SignWebViewClient extends WebViewClient {
    ...
    private SignWebViewActivity mActivity;

    public SignWebViewClient(IWebPageView mIWebPageView) {
        this.mIWebPageView = mIWebPageView;
        mActivity = (SignWebViewActivity) mIWebPageView;
