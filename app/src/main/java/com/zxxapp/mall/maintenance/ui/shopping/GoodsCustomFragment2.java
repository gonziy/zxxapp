...
public class GoodsCustomFragment2 extends BaseFragment<FragmentGoodsCustomBinding>{
    ...
    public static GoodsCustomFragment2 newInstance() {
        GoodsCustomFragment2 fragment = new GoodsCustomFragment2();
        return fragment;
    }
